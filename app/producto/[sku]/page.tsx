        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-neutral-100">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
              ...
              {/* Difficulty Badge */}
              {plant.difficulty && (
                <div className="inline-flex items-center px-4 py-2 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-700 font-semibold text-sm mb-8 w-fit shadow-sm">
                  ...
                  Nivel de Cuidados: {plant.difficulty}
                </div>
              )}
