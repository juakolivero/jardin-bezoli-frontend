...
const phoneNumber = "56979819931";

export default function WhatsAppButton() {
  const pathname = usePathname();

  let message = "Hola, quiero comprar plantas carnívoras y necesito asesoría.";

  if (pathname.includes("/producto/")) {
    const sku = pathname.split("/").pop();
    if (sku) {
      message = `Hola, estoy viendo su catálogo y tengo dudas sobre los cuidados de la planta con código: ${sku}.`;
    }
  }
